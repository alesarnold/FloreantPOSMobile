...
public abstract class TableAvailabilityTask extends AsyncTask<String, Void, TicketResponse> {

    private int tableNo;

    public TableAvailabilityTask(int tableNo) {
    ...
    protected TicketResponse doInBackground(String... urls) {
        ...
        String uri = GV.URL + "/TableAvailabilityServlet";
    ...
    public abstract void onAvailable(int tableNo);

    public abstract void onNotAvailable(final TicketResponse ticketResponse);

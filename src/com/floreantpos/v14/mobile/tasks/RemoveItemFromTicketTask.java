...
public abstract class RemoveItemFromTicketTask extends AsyncTask<String, Void, Boolean> {

    private int ticketId;
    private int ticketItemId;
    private int userId;

    public RemoveItemFromTicketTask(int ticketId, int ticketItemId,int userId) {
    ...
    protected Boolean doInBackground(String... urls) {
        ...
        String uri = GV.URL + "/RemoveItemFromTicketServlet";

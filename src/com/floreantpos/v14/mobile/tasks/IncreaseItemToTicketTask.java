...
public abstract class IncreaseItemToTicketTask extends AsyncTask<String, Void, TicketResponse> {

    private int ticketId;
    private int ticketItemId;
    private int userId;

    public IncreaseItemToTicketTask(int ticketId, int ticketItemId, int userId) {
    ...
    protected TicketResponse doInBackground(String... urls) {
        ...
        String uri = GV.URL + "/IncreaseItemToTicketServlet";

...
public abstract class AddMenuModifierToTicketItemTask extends AsyncTask<String, Void, Boolean > {

    private int modifierId;
    private int ticketItemId;
    private int userId;

    public AddMenuModifierToTicketItemTask(int ticketItemId,int modifierId, int userId) {
    ...
    protected Boolean  doInBackground(String... urls) {
        ...
        String uri = GV.URL + "/AddModifierToTicketItemServlet";
        ...
        try {
            ...
            params.add(new BasicNameValuePair("modifierId", String.valueOf(modifierId)));
